...
async function run() {
  ...
  // Actually, wait, let's just use the RPC to run the query, if we created it. No we didn't.
  // The easiest way is to look at the error details again when I inserted a fake cart:
